...
class Ui_GetNameDialog(object):
    def setupUi(self, GetNameDialog):
        ...
        self.BackgroundLbl.setStyleSheet("background: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #5ffbf1, stop:0.5 #86a8e7, stop:1 #0b1c30);\n"
"")
        self.BackgroundLbl.setText("")
        self.BackgroundLbl.setScaledContents(False)
        ...
        self.CricketerImageLbl.setGeometry(QtCore.QRect(0, 30, 111, 111))
        ...
        self.EnterTeamNameLbl.setScaledContents(True)
